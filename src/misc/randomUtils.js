...
export const ALL_DIGITS_AND_X = ALL_DIGITS + "X";
export const ALL_LETTERS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
export const ALL_LETTERS_EXCEPT_IOQ = "ABCDEFGHJKLMNPRSTUVWXYZ";
export const ALL_LETTERS_EXCEPT_IOQUZ = "ABCDEFGHJKLMNPRSTVWXY";
...
export const ALL_LETTERS_EXCEPT_IOQ_AND_ALL_DIGITS = ALL_LETTERS_EXCEPT_IOQ + ALL_DIGITS;
export const ALL_LETTERS_EXCEPT_IOQUZ_AND_ALL_DIGITS_EXCEPT_0 = ALL_LETTERS_EXCEPT_IOQUZ + ALL_DIGITS_EXCEPT_0;
